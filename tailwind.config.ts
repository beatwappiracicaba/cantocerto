...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon': '0 0 5px theme(colors.neon.purple), 0 0 10px theme(colors.neon.purple), 0 0 15px theme(colors.neon.purple)',
        'neon-lg': '0 0 10px theme(colors.neon.purple), 0 0 20px theme(colors.neon.purple), 0 0 30px theme(colors.neon.purple)',
        'luxury': '0 10px 40px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.1)',
        'luxury-lg': '0 20px 60px rgba(0, 0, 0, 0.7), 0 0 0 1px rgba(255, 255, 255, 0.1)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'luxury-dark': 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)',
